...
export const suggestions = [
  { id: "r1", label: "Centro → Sambaqui", from: "t1", to: "t5", type: "rapida", distanceKm: 8.2, durationMin: 22, priceBRL: 14.5, conditions: "Calmo", path: [[-27.5969, -48.5495], [-27.55, -48.555], [-27.52, -48.55], [-27.4914, -48.5371]] },
  { id: "r2", label: "Centro → Ribeirão da Ilha", from: "t1", to: "t4", type: "turistica", distanceKm: 18.4, durationMin: 48, priceBRL: 32, conditions: "Ondas leves", path: [[-27.5969, -48.5495], [-27.63, -48.56], [-27.68, -48.58], [-27.7172, -48.5640]] },
  { id: "r3", label: "Beira-Mar → Canasvieiras", from: "t2", to: "t6", type: "economica", distanceKm: 22.1, durationMin: 55, priceBRL: 19, conditions: "Calmo", path: [[-27.5824, -48.5476], [-27.52, -48.52], [-27.46, -48.48], [-27.4283, -48.4584]] },
  { id: "r4", label: "Lagoa → Centro", from: "t3", to: "t1", type: "tranquila", distanceKm: 12.5, durationMin: 35, priceBRL: 22, conditions: "Calmo", path: [[-27.6028, -48.4691], [-27.6, -48.5], [-27.5969, -48.5495]] },
];
