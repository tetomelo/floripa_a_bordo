...
export interface RouteSuggestion {
  ...
  from: string;
  to: string;
  type: "rapida" | "economica" | "turistica" | "tranquila" | "melhor";
  distanceKm: number;
  durationMin: number;
  priceBRL: number;
  conditions: "Calmo" | "Ondas leves" | "Agitado";
  path: [number, number][];
}

export const suggestions: RouteSuggestion[] = [
  {
...
export const FLORIPA_CENTER: [number, number] = [-27.5949, -48.548];
