...
export const Route = createFileRoute("/login")({
    head: () => ({ meta: [{ title: "Entrar — Floripa a Bordo" }] }),
    component: Login,
});
function Login() {
    ...
    return (<div className="min-h-screen bg-gradient-deep text-white relative overflow-hidden">
      ...
      <motion.form initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }} onSubmit={submit} className="relative bg-background text-foreground rounded-t-[2.5rem] px-6 pt-8 pb-10 mt-4 min-h-[60vh] shadow-float">
