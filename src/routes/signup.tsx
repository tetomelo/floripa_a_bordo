...
export const Route = createFileRoute("/signup")({
  head: () => ({ meta: [{ title: "Criar conta — Floripa a Bordo" }] }),
  component: Signup,
});
...
function Field({ icon, label, type = "text", value, onChange }: { icon: React.ReactNode; label: string; type?: string; value: string; onChange: (v: string) => void }) {
  return (
