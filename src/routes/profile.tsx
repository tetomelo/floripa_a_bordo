  ...
  return (
    <AppShell>
      ...
      <ul className="mt-6 px-5 space-y-1.5">
        {[
          { icon: Heart, label: "Rotas favoritas", to: "/favorites" as const },
          { icon: Clock, label: "Histórico", to: "/favorites" as const },
          { icon: Bell, label: "Notificações", to: "/notifications" as const },
          { icon: Settings, label: "Configurações", to: "/profile" as const },
          { icon: Shield, label: "Privacidade e segurança", to: "/profile" as const },
