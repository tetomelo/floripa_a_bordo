...
const iconMap = { cloud: CloudSun, alert: AlertTriangle, tag: Tag, route: RouteIcon };
const colorMap = {
...
function Notifications() {
    return (<AppShell>
      ...
      <div className="px-5 space-y-3">
        {notifications.map((n) => {
            const Icon = iconMap[n.icon] || CloudSun;
            return (<div key={n.id} className="rounded-2xl bg-card border border-border p-4 shadow-card flex gap-3">
